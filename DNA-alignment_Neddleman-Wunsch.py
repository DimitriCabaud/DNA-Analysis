...
def sequences_and_parameters_definition():
    ...
    print("Tape 1 for YES or 2 for NO and use the default sequences and press enter")
    print("Default sequences: GGATCGA / GAATTCAGTTA")
    answer1 = input()  
    if answer1 == 1:
        print("Please tape the first sequence and press enter")
        print("For example: GGATCGA")
        dna_vector1 = str(input())
        print("Now tape the second sequence and press enter")
        print("For example: GAATTCAGTTA")
        dna_vector2 = str(input())
    ...
    answer2 = input()
    if answer2 == 1:
        print("Please tape the value of the gap penalty and press enter")
        print("For example: -2")
        gap_penalty = input()
