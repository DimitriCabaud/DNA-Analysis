...
def interface():
    print("Hello, please tape the name of the pdb file you want to use and put it in the same folder of this program")
    print("For example: 1ubq.pdb")
    name_pdb = str(input())
    print('\n')
    data = import_data_from_pdb(name_pdb)
    print("Ok so now what type of measurement do you want to do ?")
    print("Tape 1 for distance between two C-alpha atoms")
    print("Tape 2 for angle between three C-alpha atoms")
    print("Tape 3 for dihedral angle between four C-alpha atoms")
    answer = int(input())
    print('\n')
    if answer == 1:
        print("Please tape the index of the first C-alpha atom")
        calpha1 = int(input())
        print('\n')
        print("Please tape the index of the second C-alpha atom")
        calpha2 = int(input())
        print('\n')
    ...
    if answer == 2:
        ...
        calpha2 = int(input())
        print('\n')
        print("Please tape the index of the third C-alpha atom")
        calpha3 = int(input())
        print('\n')
    ...
    if answer == 3:
        ...
        calpha3 = int(input())
        print('\n')
        print("Please tape the index of the fourth C-alpha atom")
        calpha4 = int(input())
        print('\n')
